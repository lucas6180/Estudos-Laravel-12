    <x-alert></x-alert>
    @csrf()
    <div class=" flex flex-col gap-4 w-[screen] h-[900px] justify-center items-center">
        ...
        <div>
            <img id="imagemLivro" src="{{ asset('images/icon-livro.png') }}"class="w-[150px] h-[150px] bg-cover">
        </div>
        <div class="flex justify-center flex-col w-4/6 gap-1">
            <label for="titulo" class="font-medium">Titulo</label>
            <div>
                <input placeholder="Insira o titulo do Livro" type="text" name="titulo" id="titulo"
        ...
        <input class="hidden" type="text" id="enderecoImg" name="imagem">
        <div class="flex justify-center flex-col w-4/6 gap-1">
        ...
        <div class="flex justify-center flex-col w-4/6 gap-1">
            ...
            <input placeholder="Insira o Autor do livro" type="text" name="autor"
                class="bg-slate-900 rounded-sm border-0 h-[48px]">
        </div>
        <div class="flex justify-center flex-col w-4/6 gap-1">
            <label for="quant_total" class="font-medium">Quantidade Total</label>
            <input placeholder="Insira a quantidade total" type="number" name="quantidade_total"
                class="bg-slate-900 rounded-sm border-0 h-[48px]">
        </div>
        <div class="flex justify-center flex-col w-4/6 gap-1">
            <label for="quant_disp" class="font-medium">Quantidade disponível</label>
            <input placeholder="Insira a quantidade disponivel" type="number" name="quantidade_disponivel"
                class="bg-slate-900 rounded-sm border-0 h-[48px]">
        </div>
        <button type="submit"
